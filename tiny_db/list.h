...
static inline int list_count(struct list_head *p_head)
{
    struct list_head *p_next = p_head->p_next;
    int cnt = 0;
...
static inline struct list_head * list_find(struct list_head *p_head, int pos)
{
    struct list_head *p_next = p_head->p_next;
    int idx = 0;
